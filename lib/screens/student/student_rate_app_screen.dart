...
class StudentRateAppScreen extends StatefulWidget {
  const StudentRateAppScreen({super.key});

  @override
  State<StudentRateAppScreen> createState() => _StudentRateAppScreenState();
}

class _StudentRateAppScreenState extends State<StudentRateAppScreen> {
  int _stars = 0;
