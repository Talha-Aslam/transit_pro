...
class AppTheme {
  // ── Background ────────────────────────────────────────────────────────────
  static const Color bgDarkest  = Color(0xFF0C0120);
  static const Color bgDark     = Color(0xFF110A40);
  static const Color bgDarkBlue = Color(0xFF051535);
  ...
  static BoxDecoration glassDecoration({
    ...
    return BoxDecoration(
      color: gradient == null ? (color ?? Colors.white.withOpacity(0.06)) : null,
      gradient: gradient,
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: const TextTheme(
        headlineLarge: TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.w800, letterSpacing: -1),
        headlineMedium: TextStyle(color: Colors.white, fontSize: 26, fontWeight: FontWeight.w800),
        headlineSmall: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w800),
        titleLarge: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700),
        titleMedium: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w700),
